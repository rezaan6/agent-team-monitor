    ...
    <header className="shrink-0 border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900">
      <div className="flex h-12 items-center justify-between px-6">
        ...
        <div className="flex items-center gap-2.5">
          <svg viewBox="0 0 248 248" fill="none" className="h-7 w-7" aria-label="Claude">
          ...
          <div className="flex flex-col">
            <span className="text-sm font-bold leading-tight text-gray-900 dark:text-gray-100">Claude Agent Monitor</span>
            <span className="text-[10px] text-gray-400 dark:text-gray-500">Real-time agent team tracking</span>
          </div>
